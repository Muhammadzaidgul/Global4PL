...
<option value="Please fill the shipping authorization form">New Address</option>
                                        ...
                                        <div id="Please fill the shipping authorization form" style="display:none">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" id="postalCode" onblur="getPostalDetail()" name="zipcode" class="form-control">
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>City</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" value="" name="unit_detail[]" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" name="name21[]" id="name21" value="0" onblur="sumIt()"  class="form-control">
                                            </div>
                                            
                                            <div class="form-group col-md-2">
                                                <label>Unit Value</label>
                                                <input type="text" name="name31[]" id="name31" value="0" onblur="sumIt()" class="form-control">
                                            </div>

                                            <div class="form-group col-md-2">
                                                <label>Unit Total</label>
                                                <input type="text" name="name11" id="name11" value="0" onblur="sumIt()" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="unit_detail[]" value="" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" name="name21[]" id="name42" value="0" onblur="sumIt()"  class="form-control"  class="form-control">
                                            </div>
                                            
                                            <div class="form-group col-md-2">
                                                
                                                <input type="text" name="name31[]" value="0" id="name142" onblur="sumIt()" class="form-control">
                                            </div>

                                            <div class="form-group col-md-2">
                                                
                                                <input type="text" name="name12" id="name12" value="0" onblur="sumIt()" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" name="name21[]" id="name43" value="0" onblur="sumIt()"  class="form-control"  class="form-control">
                                            </div>
                                            
                                            <div class="form-group col-md-2">
                                                
                                                <input type="text" name="name31[]" value="0" id="name143" onblur="sumIt()" class="form-control">
                                            </div>

                                            <div class="form-group col-md-2">
                                                
                                                <input type="text" name="name13" id="name13" value="0" onblur="sumIt()" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                 <input type="text" name="name21[]" id="name44" value="0"  onblur="sumIt()" class="form-control">
                                                
                                            </div>
                                            
                                            <div class="form-group col-md-2">
                                                
                                                <input type="text" name="name31[]" value="0" id="name442"  onblur="sumIt()" class="form-control">
                                            </div>

                                            <div class="form-group col-md-2">
                                                
                                                <input type="text" name="name14" id="name14" value="0" onblur="sumIt()" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" name="name16" id="name16" value="0" onblur="sumIt()" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" name="req_sign" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" name="no_of_pc" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group col-md-2">
                                                <label>Total:</label>
                                                <input type="text" id="total" value="0" onblur="sumIt()" name="total" class="form-control">
                                            </div>
