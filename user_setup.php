                                    ...
                                    <form method="post" action="#" name="frm" onkeydown="return (event.keyCode!=13);" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="comp_name" placeholder="Client/Company Name" required>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Username for login" name="user_name" required>

                                            </div>
                                            <div class="form-group col-md-3">
                                                <label>Password </label>
                                                
                                                <input type="password" class="form-control" placeholder="Password for login" name="user_pass" required>
